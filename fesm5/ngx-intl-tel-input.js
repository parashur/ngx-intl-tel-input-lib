import { ɵɵdefineInjectable, Injectable, Component, forwardRef, Input, Output, ViewChild, EventEmitter, NgModule } from '@angular/core';
...
var NgxIntlTelInputService = /** @class */ (function () {
    ...
    /** @nocollapse */ NgxIntlTelInputService.ngInjectableDef = ɵɵdefineInjectable({ factory: function NgxIntlTelInputService_Factory() { return new NgxIntlTelInputService(); }, token: NgxIntlTelInputService, providedIn: "root" });
    ...
    */
    ...
    function () {
        ...
        if (!this.value) {
            ...
            /** @type {?} */
            var intlNo = number ? this.phoneUtil.format(number, PhoneNumberFormat.INTERNATIONAL) : '';
...
export { CountryISO, NgxIntlTelInputComponent, NgxIntlTelInputModule, NgxIntlTelInputService, SearchCountryField, TooltipLabel, CountryCode as ɵa, phoneNumberValidator as ɵb };
